...
def choose_hero():
    ...
    if request.method == "GET":
        ...
        result = {"header": "Выберите героя", "classes": classes, "weapons": weapons, "armors": armors}
...
def choose_enemy():
    ...
    if request.method == "GET":
        ...
        result = {"header": "Выберите противника", "classes": classes, "weapons": weapons, "armors": armors}
        return render_template("hero_choosing.html", result=result)
    elif request.method == "POST":
        name = request.form["name"]
        armor_name = request.form["armor"]
